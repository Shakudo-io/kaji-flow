...
Customize agent models, prompts, and permissions in `kajiflow.json`. See [Configuration](configurations.md#agents).
...
| Tool | Description |
|------|-------------|
| **call_kaji_agent** | Spawn explore/librarian agents. Supports `run_in_background`. |
