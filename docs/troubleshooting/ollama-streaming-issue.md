...
When using Ollama as a provider with kajiflow agents, you may encounter:
...
- **kajiflow**: Passes through the SDK's behavior (can't fix at this layer)
...
- **kajiflow**: https://github.com/code-yeongyu/kajiflow/issues/1124
