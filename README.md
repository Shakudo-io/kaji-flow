...
>
> KajiFlow is **free and open-source**. Do **not** download installers or enter payment details on third-party sites that claim to be "official."
>
...
>
> ✅ Official downloads: https://github.com/code-yeongyu/kajiflow/releases
...
> [!TIP]
>
> [![KajiFlow 3.0 is now stable!](./.github/assets/orchestrator-atlas.png?v=3)](https://github.com/code-yeongyu/kajiflow/releases/tag/v3.0.0)
> > **KajiFlow 3.0 is now stable! Use `kajiflow@latest` to install it.**
>
> Be with us!
>
> | [<img alt="Discord link" src="https://img.shields.io/discord/1452487457085063218?color=5865F2&label=discord&labelColor=black&logo=discord&logoColor=white&style=flat-square" width="156px" />](https://discord.gg/PUwSMR9XNk) | Join our [Discord community](https://discord.gg/PUwSMR9XNk) to connect with contributors and fellow `kajiflow` users. |
> | :-----| :----- |
> | [<img alt="X link" src="https://img.shields.io/badge/Follow-%40justsisyphus-00CED1?style=flat-square&logo=x&labelColor=black" width="156px" />](https://x.com/justsisyphus) | News and updates for `kajiflow` used to be posted on my X account. <br /> Since it was suspended mistakenly, [@justsisyphus](https://x.com/justsisyphus) now posts updates on my behalf. |
...
> This is coding on steroids—`kajiflow` in action. Run background agents, call specialized agents like oracle, librarian, and frontend engineer. Use crafted LSP/AST tools, curated MCPs, and a full Claude Code compatibility layer.

# Claude OAuth Access Notice

## TL;DR

> Q. Can I use kajiflow?
...
>
> [**Anthropic has cited this project, kajiflow as justification for blocking opencode.**](https://x.com/thdxr/status/2010149530486911014)
>
...
> "use kajiflow, you will never go back" — [d0t3ch](https://x.com/d0t3ch/status/2001685618200580503)
...
> "KajiFlow Is Actually Insane" - [YouTube - Darren Builds AI](https://www.youtube.com/watch?v=G_Snfh2M41M)
...
3. Stop worrying about context management when delegating to LLMs. I've got it covered.
    - KajiFlow aggressively leverages multiple agents to lighten the context load.
...
1. **Remove the plugin from your OpenCode config**
   ...
   Edit `~/.config/opencode/opencode.json` (or `opencode.jsonc`) and remove `"kajiflow"` from the `plugin` array:
...
**Quick Overview:**
- **Config Locations**: `.opencode/kajiflow.json` (project) or `~/.config/opencode/kajiflow.json` (user)
...
If OpenCode is Debian/Arch, KajiFlow is Ubuntu/[Omarchy](https://omarchy.org/).
...
- If you're on [1.0.132](https://github.com/sst/opencode/releases/tag/v1.0.132) or older, an OpenCode bug may break config.
  - [The fix](https://github.com/sst/opencode/pull/5040) was merged after 1.0.132—use a newer version.
    - Fun fact: That PR was discovered and fixed thanks to KajiFlow's Librarian, Explore, and Oracle setup.
