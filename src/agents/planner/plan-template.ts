...
Generate plan to: \`.kajiflow/work/plans/{name}.md\`
...
- **Evidence Paths**: Specific file paths (\`.kajiflow/work/evidence/task-N-scenario-name.png\`)
...
- Screenshots: \`.kajiflow/work/evidence/\` for all UI verifications
...
- [ ] 1. [Task Title]
  ...
  **Example — Frontend/UI (Playwright):**
  ...
  Scenario: Successful login redirects to dashboard
    ...
    Steps:
      ...
      9. Screenshot: .kajiflow/work/evidence/task-1-login-success.png
    Expected Result: Dashboard loads with welcome message
    Evidence: .kajiflow/work/evidence/task-1-login-success.png
  ...
  Scenario: Login fails with invalid credentials
    ...
    Steps:
      ...
      8. Screenshot: .kajiflow/work/evidence/task-1-login-failure.png
    Expected Result: Error message shown, stays on login page
    Evidence: .kajiflow/work/evidence/task-1-login-failure.png
  \\\`\\\`\\\`
  ...
  **Evidence to Capture:**
  - [ ] Screenshots in .kajiflow/work/evidence/ for UI scenarios
