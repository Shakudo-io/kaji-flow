...
describe("disabled_mcps schema", () => {
  test("should accept built-in MCP names", () => {
    ...
    // when
    const result = KajiFlowConfigSchema.safeParse(config)
...
describe("KajiFlowConfigSchema - browser_automation_engine", () => {
  test("accepts browser_automation_engine config", () => {
    ...
    // when
    const result = KajiFlowConfigSchema.safeParse(input)
