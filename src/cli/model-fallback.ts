...
export interface GeneratedKajiConfig {
  $schema: string
...
const SCHEMA_URL = "https://raw.githubusercontent.com/code-yeongyu/kajiflow/master/assets/kajiflow.schema.json"
...
export function generateModelConfig(config: InstallConfig): GeneratedKajiConfig {
