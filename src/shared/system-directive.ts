/**
 * Unified system directive prefix for kajiflow internal messages.
 * All system-generated messages should use this prefix for consistent filtering.
 *
 * Format: [SYSTEM DIRECTIVE: KAJIFLOW - {TYPE}]
 */

export const SYSTEM_DIRECTIVE_PREFIX = "[SYSTEM DIRECTIVE: KAJIFLOW"

/**
 * Creates a system directive header with the given type.
 * @param type - The directive type (e.g., "TODO CONTINUATION", "RALPH LOOP")
 * @returns Formatted directive string like "[SYSTEM DIRECTIVE: KAJIFLOW - TODO CONTINUATION]"
 */
...
/**
 * Checks if a message starts with the kajiflow system directive prefix.
