      ...
      ? Object.fromEntries(
          Object.entries(configAgent)
            .filter(([key]) => {
              ...
              // Filter out agents that kajiflow provides to prevent
              // OpenCode defaults from overwriting user config in kajiflow.json
              // See: https://github.com/code-yeongyu/kajiflow/issues/472
