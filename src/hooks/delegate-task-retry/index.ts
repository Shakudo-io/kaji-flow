...
export const DELEGATE_TASK_ERROR_PATTERNS: DelegateTaskErrorPattern[] = [
  ...
  },
  {
    ...
    fixHint: "Provide ONLY one of: category (e.g., 'general', 'quick') OR subagent_type (e.g., 'advisor', 'context-finder')",
  },
  {
    pattern: "Must provide either category or subagent_type",
    errorType: "missing_category_or_agent",
    fixHint: "Add either category='general' OR subagent_type='context-finder'",
  },
  {
  ...
  },
  {
    ...
    fixHint: "Primary agents cannot be called via task. Use a subagent like 'context-finder', 'advisor', or 'researcher'",
  },
  {
...
task(
  ...
  category="unspecified-low",  // OR subagent_type="context-finder"
